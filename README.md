...
- Spot **USD/BRL** com fallback (`goldprice.dev` → `goldprice.org`)
...
|---|---|---|---|
| Spot USD (onça) | `goldprice.dev` | `goldprice.org` | — |
...
- Combustível vence após **14 dias** (2 releases semanais perdidas).
